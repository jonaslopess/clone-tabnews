...
function Home() {
  return (
    <div>
      <h1>Você está preparado para o futuro?</h1>

      <p>Se a sua resposta for sim, vocês está no lugar errado...</p>

      <p>Esta é uma comunidade de pessoas inquietas e curiosas. </p>
      <p>
        Sabemos que não importa o quão atualizados estejam nossos conhecimentos.{" "}
      </p>
